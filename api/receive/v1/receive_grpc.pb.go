...
const (
	ReceiveService_Receive_FullMethodName = "/receive.v1.ReceiveService/Receive"
)
...
func (c *receiveServiceClient) Receive(ctx context.Context, in *ReceiveRequest, opts ...grpc.CallOption) (*ReceiveReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReceiveReply)
	err := c.cc.Invoke(ctx, ReceiveService_Receive_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReceiveServiceServer) Receive(context.Context, *ReceiveRequest) (*ReceiveReply, error) {
...
func _ReceiveService_Receive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReceiveService_Receive_FullMethodName,
	}
...
var ReceiveService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "receive.v1.ReceiveService",
	...
	Metadata: "receive/v1/receive.proto",
}
